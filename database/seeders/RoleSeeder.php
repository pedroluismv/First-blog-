...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.categories.edit', 'description' => 'Editar categoria'])->assignRole($role1);
        ...
        Permission::create(['name' => 'admin.tags.create', 'description' => 'Crear etiqueta'])->assignRole($role1);
        Permission::create(['name' => 'admin.tags.edit', 'description' => 'Editar etiqueta'])->assignRole($role1);
        Permission::create(['name' => 'admin.tags.destroy', 'description' => 'Eliminar etiqueta'])->assignRole($role1);
